  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 min-h-[280px]">
      <div className="relative flex items-center justify-center w-24 h-24">
        ...
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-cyan-500 via-blue-500 to-purple-500 blur-md opacity-40 animate-pulse" />

        {/* Spinning gradient border */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 animate-spin border-2 border-transparent [mask-image:linear-gradient(white,transparent)]" />
